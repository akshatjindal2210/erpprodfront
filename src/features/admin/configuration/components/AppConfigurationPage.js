...
import AppConfigTabBar from "@/features/admin/configuration/components/AppConfigTabBar";
import {
  buildAppConfigTabHref,
  parseAppConfigTabFromSearchParams,
} from "@/features/admin/configuration/config/appConfigTabsRegistry";
import { getAppConfigPanel } from "@/features/admin/configuration/config/appConfigPanels";
