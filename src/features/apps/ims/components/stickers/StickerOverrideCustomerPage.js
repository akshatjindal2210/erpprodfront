...
import { Plus, ScanLine, RefreshCcw, Shield, X, FileText, Printer } from "lucide-react";
        ...
        <ListPageToolbar>
          <ListPageToolbarLayout
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <ActionButton 
                module="change_override_customer" action="authorize" variant="outline" label="Approve" icon={Shield} 
                disabled={!selected} 
