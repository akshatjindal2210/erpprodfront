...
import { Plus, Loader2, User, LayoutGrid, List, X, Minimize2, Maximize2, } from "lucide-react";
...
export default function TasksPage() {
  ...
  const [quickFilter,    setQuickFilter]    = useState("action_required");
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      const params = {
        ...
        // task_type: activeTab === "self" ? "self" :  activeTab === "assigned_by_me" ? "assigned" : undefined,
  ...
  }, [page, pageSize, search, statusFilter, priorityFilter, categoryFilter,
  ...
  const clearAllFilters = () => {
    ...
    setPriorityFilter("All"); setCategoryFilter("All"); setUserFilter("All");
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 bg-white hover:bg-violet-50 border border-slate-200 hover:border-violet-200 text-slate-700 hover:text-violet-700 text-sm font-medium px-4 py-2.5 rounded-xl transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
            <User size={15} className="text-violet-500" /> Self Task
          </button>
          <button
            onClick={() => { setEditTask(null); setModalOpen(true); }}
            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-4 py-2.5 rounded-xl transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
        ...
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-slate-100 space-y-3 flex-shrink-0 bg-white z-[10]">
            ...
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3">
              {/* Search Bar - Mobile par full width, Desktop par flexible */}
              ...
              {/* Actions Group - space-between in one line on mobile */}
            ...
            {showFilters && (
              <TaskFilterPanel
                ...
                onUserChange={(u) => { setUserFilter(u); setPage(1); }}
            ...
            <div className="flex-1 overflow-auto relative h-[600px] border border-slate-200 rounded-lg">
              <table className="w-full text-sm min-w-[1100px] border-separate border-spacing-0">
                ...
                <tbody className="divide-y divide-slate-100">
                  {loading ? (
                    <tr>
                      <td colSpan={TABLE_COLS.length + 3} className="py-16 text-center text-slate-400">
                    ...
                    <tr>
                      <td colSpan={TABLE_COLS.length + 3} className="py-16 text-center">
