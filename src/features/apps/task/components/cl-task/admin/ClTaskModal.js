...
const WIZARD_STEPS = [
  ...
  },
  {
    id: "review",
    label: "Create",
    hint: "Optional questions — then submit once to create the task.",
  },
];

/** Assign step index (Task=0, Assign=1, Create=2) */
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5 rounded-lg border border-slate-100 bg-slate-50/50 p-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <ClFormToggle
                    compact
                    label={form.sop_required ? "Acknowledgment required" : "Optional"}
                    description="When required, assignee must acknowledge before submit"
                ...
                <RichTextEditor
                  ...
                  placeholder="Step-by-step SOP (optional)…"
                />
