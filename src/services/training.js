...
const S = ENDPOINTS.TRAINING_VIDEOS.SOPS;

export const trainingVideoService = {
  getAll:  (params)   => api(ENDPOINTS.TRAINING_VIDEOS.LIST,   { method: "POST", body: params }),
  getById: (id, perms = {})       => api(ENDPOINTS.TRAINING_VIDEOS.GET,    { method: "POST", body: { id, ...perms } }),
  ...
  getViews: (params)  => api(ENDPOINTS.TRAINING_VIDEOS.VIEWS,  { method: "POST", body: params }),
  getViewById: (id, perms = {}) => api(ENDPOINTS.TRAINING_VIDEOS.VIEWS, { method: "POST", body: { id, ...perms } }),
};
