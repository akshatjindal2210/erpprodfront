...
/** list: type "" | "register" · register may send from_date/to_date (YYYY-MM-DD) → IMS filter.data */
export const invoiceReceivingService = {
  list: (type = "", { from_date, to_date, fromDate, toDate } = {}) => {
  ...
  update: async ({
    ...
    const fields = { prnbillno, billdt, receivingfile, file_path, uploaded_by, uploaded_at, acc_name };
