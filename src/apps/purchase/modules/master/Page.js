...
import { masterService } from "@/apps/purchase/lib/services/master";
...
import { useMasterClientList } from "@/apps/purchase/lib/helpers/useMasterClientList";
import { MasterSelectionBanner, MasterListFooter, MasterRefreshButton } from "@/apps/purchase/lib/helpers/masterListUi";
...
export default function ProductMasterPage() {
  const lockedGroup = PURCHASE_GROUP_NAME;
  ...
  const preFilter = useCallback(
    (rows) => {
      const needle = lockedGroup.toLowerCase();
