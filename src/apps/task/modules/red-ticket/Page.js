...
import { Plus, Trash2, RefreshCcw, Edit3, AlertTriangle } from "lucide-react";
...
import { redTicketService } from "@/apps/task/lib/services/redTicketApi";
import { useClTaskFilters } from "@/apps/task/lib/hooks/useClTaskFilters";
import { formatTaskUserOptionLabel, formatDateTime } from "@/apps/task/lib/helpers/utilHelper";
    ...
    <div className={IMS_LIST_PAGE_SHELL}>
      <div className="bg-white border border-slate-300 flex flex-col flex-1 min-h-0 rounded-none shadow-sm overflow-hidden">
        ...
        <AppListFooter
          ...
          selectionLabel={(r) => consoleListSelectionLabel.redTicket(r, selected)}
