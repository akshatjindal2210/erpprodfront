...
import UnauthorizedBanner from "@/apps/task/lib/UnauthorizedBanner";

// ── Shared components
import DashboardHeader  from "@/apps/task/manage/dashboard/DashboardHeader";
import QuickActions     from "@/apps/task/manage/dashboard/QuickActions";

// ── Staff components
import UsersSection        from "@/apps/task/manage/dashboard/UsersSection";
import TasksSection        from "@/apps/task/manage/dashboard/TasksSection";
import TaskChartRow        from "@/apps/task/manage/dashboard/TaskChartRow";
import DeptAndRemindersRow from "@/apps/task/manage/dashboard/DeptAndRemindersRow";
import TasksAndUsersRow    from "@/apps/task/manage/dashboard/TasksAndUsersRow";

// ── User components (shown when HIDE_DASHBOARD_FROM_USERS = false)
import UserTasksSection  from "@/apps/task/manage/dashboard/UserTasksSection";
import UserChartsRow     from "@/apps/task/manage/dashboard/UserChartsRow";
import UserAssignedTasks from "@/apps/task/manage/dashboard/UserAssignedTasks";
import { canViewTaskDashboard } from "@/apps/task/lib/config/appConfig";
