...
export const ENDPOINTS = {
  ...
  INVENTORY_AUDIT: {
    LIST: `${BASE}/inventory-audit/list`,
    GET: `${BASE}/inventory-audit/get`,
    CREATE: `${BASE}/inventory-audit/create`,
    UPDATE: `${BASE}/inventory-audit/update`,
    DELETE: `${BASE}/inventory-audit/delete`,
    SUBMIT_SCAN: `${BASE}/inventory-audit/submit-scan`,
    START_LOCATION: `${BASE}/inventory-audit/start-location`,
    REMOVE_SCAN: `${BASE}/inventory-audit/remove-scan`,
    COMPARISON_REPORT: `${BASE}/inventory-audit/comparison-report`,
    COMPARISON_ADJUSTMENT: `${BASE}/inventory-audit/comparison-adjustment`,
    COMPLETE_LOCATION: `${BASE}/inventory-audit/complete-location`,
    SCORES: `${BASE}/inventory-audit/scores`,
    REOPEN_LOCATION: `${BASE}/inventory-audit/reopen-location`,
    REASSIGN_LOCATION: `${BASE}/inventory-audit/reassign-location`,
    VERIFY: `${BASE}/inventory-audit/verify`,
  },
