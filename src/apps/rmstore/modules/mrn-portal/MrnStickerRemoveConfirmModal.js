...
/** IMS StickerRemoveConfirmModal analog for RM coil stickers. */
export default function MrnStickerRemoveConfirmModal({
  open,
  mrnNo,
  onClose,
  onConfirm,
  ...
  if (!open || mrnNo == null || String(mrnNo).trim() === "") return null;
        ...
        <div className="px-5 py-4 space-y-3 overflow-y-auto">
          ...
          <div className="flex gap-2.5 p-3 bg-rose-50 border border-rose-100 rounded-xl">
            ...
            <p className="text-xs text-rose-700 leading-snug">
              Coil stickers for MRN <span className="font-bold">#{mrnNo}</span> will be deleted
              permanently. Any store-in coils must be reversed first. You can generate them again when ready.
            </p>
          </div>
        </div>
