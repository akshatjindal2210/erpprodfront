...
export { MODULE_DISABLED_MESSAGE, NO_ACCESS_MESSAGE, FLOW_SCAN_REJECTED_MSG, FLOW_SCAN_CAMERA_ERROR_MSG, SCAN_SNACK_MSG } from "@/global";
...
export const selectCls = "w-full bg-white border border-slate-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition-all";
