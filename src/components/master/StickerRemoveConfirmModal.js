    ...
    <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4" data-app-drawer-root>
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl border border-slate-200 max-h-[90dvh] flex flex-col overflow-hidden">
        ...
        <div className="px-5 py-4 space-y-4 overflow-y-auto">
          <div className="px-1 py-2 border-b border-amber-200 bg-amber-50/40 rounded-lg">
          ...
          <div className="flex gap-3 p-3 bg-rose-50 border border-rose-100 rounded-xl">
            ...
            <p className="text-xs text-rose-700 leading-relaxed">
              Permanently delete all box rows for packing <span className="font-bold">#{docNo}</span>. This cannot be undone.
            </p>
          </div>
        </div>
