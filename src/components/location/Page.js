...
import { applyClientSearch, fetchAllListPages } from "@/helpers/clientListSearch";
        ...
        <div className="px-3 py-2 bg-white border-b border-slate-200 flex flex-col gap-2 shrink-0">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <ActionButton module="location_master" action="view" variant="outline" label="Print QR" icon={Printer} disabled={!selected || !selectedRecord?.approved} onClick={openPrintModal} title="Print QR label (Ctrl+Alt+P / Ctrl+P in app)" className="rounded-none h-9 bg-white text-[11px] font-bold uppercase px-4 border-slate-300 shadow-none" />
