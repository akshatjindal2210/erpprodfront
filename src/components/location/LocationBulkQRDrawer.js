...
import { buildLocationLabelDataUrlsForRows, downloadLocationLabelDataUrl, getLocationDisplayNo, printLocationLabelDataUrls } from "@/helpers/locationQrLabel";
...
export default function LocationBulkQRDrawer({
  ...
  return (
    <Drawer
      ...
      description="Print or download all authorized locations in one action (500, 1000, or more). No manual 100-at-a-time steps — processing is automatic."
      maxWidth="max-w-lg"
    >
