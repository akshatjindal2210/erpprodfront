...
import { FileText, Activity, ShieldCheck, Clock, History } from "lucide-react";
...
export const QUICK_LINKS_CONFIG = [
  ...
  { id: "security", label: "User Management", icon: <ShieldCheck size={13} />, path: ROUTES.USERS, module: "users" }, 
