import { Zap, Package, Truck, Users, Database, FileSearch, BarChart3, Globe, UserPlus, Map, Boxes, ClipboardCheck, ListChecksIcon, Locate, ClipboardList, Scale, Sticker, Ship, Settings, History } from "lucide-react";
...
export const NAV_REGISTRY = [
  { id: "dashboard", name: "Dashboard", icon: <Zap size={16} />, href: ROUTES.DASHBOARD, module: null },
  {
    ...
    module: null,
    subItems: [
      { id: "users", name: "User Management", icon: <UserPlus size={14} />, href: ROUTES.USERS, module: "users" },
      { id: "modules", name: "System Module", icon: <Globe size={14} />, href: ROUTES.MODULES, module: "modules" },
      { id: "training", name: "Training Videos", icon: <ListChecksIcon size={14} />, href: ROUTES.TRAINING, module: "training_videos" },
    ],
  },
  {
    id: "masters-group",
