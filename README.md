...
**Current release:** [v3.4.38](./readme/version-notes/v3.4.38.md) — CL Task Report · Tasks stat cards · Not Viewed fix · Holiday import · IMS Box dispatch (SA-id collision)  
